...
* {:.next} Размещать произвольное количество наборов топорами в любой последовательности
* {:.next} Если возникает ошибка в одном из наборов, остальные подгружаются как есть
* {:.next} Первые набора топоров должны показываться сразу, не ожидая прогрузки всех остальных

## Иллюстрация множественных каруселей
-- ТУТ ИЛЛЮСТРАЦИЯ КАРУСЕЛЕЙ --
...
Дадим этому понятию определение.
...
... * Redux при грамотном использовании позволяет дедуплецировать и легко обновлять данные
