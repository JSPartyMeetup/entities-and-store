...
- Redux подталкивает нас к нормализации потому что:
> Дедуплекация
> Проще обновление данных и логика редьюсеров
> Меньше перерисовок
- Возможно сделать единый источник истины для всего приложения
